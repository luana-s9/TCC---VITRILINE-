const produtos = [
  ...
  { id: 16, nome: "Pantufa",          categoria: "Calçados",  preco: 40.00, precoStr: "R$ 40,00",  tamanho: "36/38",         img: "images/produto_100.jpeg", desc: "Akatsuki de Naruto. Conforto de elite para os fãs de anime! Perfeita para os dias frios com muito estilo geek." },
  { id: 17, nome: "Tênis Cavalera Lorran",              categoria: "Calçados",  preco: 30.00, precoStr: "R$ 30,00",  tamanho: "41",         img: "images/produto_82.jpeg", desc: "Um clássico em camurça amarela. Confortável, moderno e no tamanho ideal para destacar qualquer visual casual." },
  { id: 18, nome: "Tênis masculino",              categoria: "Calçados",  preco: 25.00, precoStr: "R$ 25,00",  tamanho: "42", img: "images/produto_84.jpeg", desc: "Prático e elegante na cor branca/off-white. Confeccionado em couro." },
  { id: 19, nome: "TÊnis feminino Fila",                categoria: "Calçados",  preco: 35.00, precoStr: "R$ 35,00",  tamanho: "34",         img: "images/produto_85.jpeg", desc: "​Conforto esportivo e leveza para a sua rotina. Modelo preto discreto." },

  // --- BLUSAS ---
 
 { id: 39, nome: "Camisola branca",        categoria: "Blusas",    preco: 29.99, precoStr: "R$ 29,99",  tamanho: "M",        img: "images/produto_49.jpg", desc: "Uma camisola curta e fluida com tecido plissado, alças de amarração e detalhes em renda delicada no busto e na barra." },
  { id: 40, nome: "Camisola preta",       categoria: "Blusas",    preco: 29.90, precoStr: "R$ 29,90",  tamanho: "M/G",          img: "images/produto_74.jpg", desc: " Uma camisola curta com sutiã estruturado decorado com brilhos, corpo transparente, fenda lateral com laço de cetim e acabamento em renda trabalhada." },
  ...
  // --- CALÇAS E BERMUDAS ---
  { id: 44, nome: "Legging preta corino",           categoria: "Calças e bermudas",    preco: 30.00, precoStr: "R$ 30,00",  tamanho: "M",         img: "images/produto_46.jpg", desc: "Calça modelo montaria em tecido cirre com acabamento que imita couro. Cintura alta com cós largo que modela e não marca. Tecido com ótimo stretch, veste super bem no corpo sem ficar transparente." },
  { id: 45, nome: "Calça jeans feminina verde escuro",              categoria: "Calças e bermudas",    preco: 10.90, precoStr: "R$ 10,90",  tamanho: "44",          img: "images/produto_60.jpg", desc: "Calça skinny na cor verde militar. Modelagem que alonga e afina as pernas. Tecido com elastano que garante conforto pra usar o dia todo sem apertar." },
  { id: 46, nome: "Calça feminina Branca Alfaiataria",                 categoria: "Calças e bermudas",    preco: 20.00, precoStr: "R$ 20,00",  tamanho: "40",         img: "images/produto_64.jpg", desc: "Calça pantalona em tecido de alfaiataria. Modelagem elegante com cintura alta e pernas amplas. Tecido encorpado que tem caimento perfeito e não marca o corpo." },
  { id: 47, nome: "Pantacourt de couro preto",          categoria: "Calças e bermudas",    preco: 29.99, precoStr: "R$ 29,99",  tamanho: "GG",          img: "images/produto_66.jpg", desc: "Modelagem ampla, soltinha e super estilosa. Cintura alta com elástico embutido + cordão ajustável. A barra é mais curta, na altura da canela." },
  { id: 48, nome: "Bermuda masculina Xadrez",        categoria: "Calças e bermudas",    preco: 12.00, precoStr: "R$ 12,00",  tamanho: "M",         img: "images/produto_44.jpg", desc: "bermuda masculina de estilo casual e despojado." },
  { id: 49, nome: "Calça Jens masculina",            categoria: "Calças e bermudas",    preco: 25.00, precoStr: "R$ 25,00",  tamanho: "44",         img: "images/produto_83.jpeg", desc: "Um item essencial em qualquer guarda-roupa. Jeans escuro versátil e resistente." },
  { id: 50, nome: "Calça jeans masculina azul escuro",           categoria: "Calças e bermudas",    preco: 35.00, precoStr: "R$ 35,00",  tamanho: "46",         img: "images/produto_87.jpeg", desc: "​Corte reto tradicional com lavagem escura impecável. Perfeita para combinar com tudo." },
  { id: 51, nome: "Calça adidas",                categoria: "Calças e bermudas",    preco: 34.90, precoStr: "R$ 34,90",  tamanho: "M",         img: "images/produto_88.jpeg", desc: "​Conforto e mobilidade no estilo esportivo clássico. Peça preta, perfeita para looks despojados." },
  { id: 52, nome: "Leggin preta",               categoria: "Calças e bermudas",    preco: 30.00, precoStr: "R$ 30,00",  tamanho: "P",         img: "images/produto_89.jpeg", desc: "Legging preta confeccionada em tecido elástico de alta resistência. Alia conforto e elasticidade — ideal para exercícios, yoga ou looks casuais do dia a dia." },
  { id: 55, nome: "Pijama feminino",                categoria: "Calças e bermudas",    preco: 15.00, precoStr: "R$ 15,00",  tamanho: "GG",          img: "images/produto_90.jpeg", desc: "Tecido super leve e estampa divertida para garantir as noites de sono mais confortáveis." },
  { id: 56, nome: "Biquíni parte de baixo com bermuda",          categoria: "Calças e bermudas",    preco: 45.00, precoStr: "R$ 45,00",  tamanho: "P",          img: "images/produto_86.jpeg", desc: "Ideal para dias de calor, peça com tecido fino e refrescante." },

  // --- SAIAS e vestidos ---
  { id: 81, nome: "Saia Jeans Azul",    categoria: "Saias e vestidos",     preco: 35.00, precoStr: "R$ 35,00",  tamanho: "44",        img: "images/produto_70.jpg", desc: "Saia midi jeans modelo lápis com fenda frontal profunda. Peça nova, sem uso, com etiqueta da marca Camarote Jeans. Cintura alta que modela o corpo. Lavagem jeans média, atemporal e super fácil de combinar." },
  { id: 82, nome: "Vestido preto",             categoria: "Saias e vestidos",     preco: 20.00, precoStr: "R$ 20,00",  tamanho: "Plus size",          img: "images/produto_92.jpeg", desc: "Elegante e fluído, traz um caimento perfeito com um detalhe charmoso nas costas." },
  { id: 83, nome: "Vestido de festa",             categoria: "Saias e vestidos",     preco: 25.00, precoStr: "R$ 25,00",  tamanho: "M",          img: "images/produto_93.jpeg", desc: "Um toque de sofisticação com mangas longas trabalhadas em transparência e brilho sutil." },
  { id: 84, nome: "Vestido básico cinza",      categoria: "Saias e vestidos",     preco: 19.90, precoStr: "R$ 19,90",  tamanho: "M",      img: "images/produto_95.jpeg", desc: "Modelo leve e casual, ideal para dias descontraídos. Conta com um charme especial no detalhe trançado atrás." },
  { id: 85, nome: "Vestido de festa",             categoria: "Saias e vestidos",     preco: 18.90, precoStr: "R$ 18,90",  tamanho: "P/M",      img: "images/produto_98.jpeg", desc: "Alcinhas finas e caimento fluido com detalhes em brilho discreto para você destacar na noite." },
  { id: 86, nome: "Saia jeans preta",      categoria: "Saias e vestidos",     preco: 20.00, precoStr: "R$ 20,00",  tamanho: "42",      img: "images/produto_97.jpeg", desc: "Modelagem midi estilosa com costura contrastante em branco. Uma peça moderna e atempora." },
  { id: 87, nome: "Saia curta",             categoria: "Saias e vestidos",     preco: 17.90, precoStr: "R$ 17,90",  tamanho: "P",      img: "images/produto_99.jpeg", desc: "​Estampa clássica em tons de marrom e preto com fendas discretas na barra." },
  ...
  { id: 59, nome: "Meias calças | Novas",             categoria: "Novidades",  preco: 15.00, precoStr: "R$ 15,00",  tamanho: "G/GG",          img: "images/produto_94.jpeg", desc: "Meia-calça Loba Clássica Fio 15, fina e elegante para o dia a dia." },
  { id: 60, nome: "Cinto básico preto",             categoria: "Novidades",  preco: 10.00, precoStr: "R$ 10,00",  tamanho: "M",          img: "images/produto_96.jpeg", desc: "Cinto largo preto com fivela retangular, perfeito para modelar a cintura." },
  { id: 61, nome: "Capa de chuva",             categoria: "Novidades",  preco: 6.00, precoStr: "R$ 6,00",  tamanho: "único",          img: "images/produto_102.jpeg", desc: "Capa de chuva descartável transparente com capuz, prática e compacta." },
  { id: 62, nome: "Ursos de pelúcia",             categoria: "Novidades",  preco: 30.00, precoStr: "R$ 30,00",     img: "images/produto_103.jpeg", desc: "Leve os dois por R$30,00" },
  ...
  { id: 75, nome: "Casaco feminino",      categoria: "Agasalhos", preco: 15.90, precoStr: "R$ 15,90",  tamanho: "M",          img: "images/produto_78.jpg", desc: "Jaqueta esportiva leve. Corta-vento com moletom fino." },
   { id: 76, nome: "Suéter feminino bege listrado",     categoria: "Agasalhos",    preco: 22.00, precoStr: "R$ 22,00",  tamanho: "M",          img: "images/produto_30.jpg", desc: "Suéter feminino de tricot com estampa listrada em azul-escuro e caramelo. Modelagem mais larguinha e mangas longas em estilo raglan (com os ombros e braços na cor clara)." },
  { id: 77, nome: "Blusa térmica femnina verde escuro",         categoria: "Agasalhos",    preco: 29.90, precoStr: "R$ 29,90",  tamanho: "M",        img: "images/produto_32.jpg", desc: "Blusa térmica feminina verde-escura, com mangas longas e gola redonda. Ela possui um design liso, básico e com caimento ajustado ao corpo." },
  { id: 78, nome: "Moletom feminino rosa | Pijama",         categoria: "Agasalhos",    preco: 20.00, precoStr: "R$ 20,00",  tamanho: "M",        img: "images/produto_52.jpg", desc: "Blusa de moletom gola careca na cor rosa-salmão, perfeita para o dia a dia ou como pijama quentinho. Possui interior macio, punhos e barra canelados, e uma estampa super fofa de dinossauro em estilo oriental. Confortável, quentinho e estiloso." },
  { id: 79, nome: "Moletom masculino preto",         categoria: "Agasalhos",    preco: 29.99, precoStr: "R$ 29,99",  tamanho: "M",        img: "images/produto_54.jpg", desc: "Moletom preta gola careca, confortável e com interior macio. Possui estampa frontal da marca em verde e dourado, além de detalhe na manga. Punhos e barra em ribana garantem ótimo ajuste. Perfeito para o estilo urbano do dia a dia." },
  { id: 80, nome: "Touca infantil | pelúcia",         categoria: "Agasalhos",    preco: 15.00, precoStr: "R$ 15,00",  tamanho: "P",        img: "images/produto_91.jpeg", desc: "Touca de pelúcia para bebês, macia e confortável." },
...
const categorias = ["Todos", "Calçados", "Blusas", "Calças e bermudas", "Saias e vestidos", "Novidades", "Agasalhos"];
    ...
    <div class="modal" role="dialog" aria-modal="true">
      ...
      <div class="modal-body">
        ...
        <button class="btn-add-cart-modal" id="modal-btn-cart">
          <img src="icons/carrinho-de-compras.png" alt="Carrinho" class="btn-comprar-icone"> Adicionar ao Carrinho
        </button>
    ...
    <div class="produto-info">
      ...
      <div class="produto-acoes">
        ...
        <button class="btn-add-cart" onclick="adicionarAoCarrinho(${prod.id})">
          <img src="icons/carrinho-de-compras.png" alt="Comprar" class="btn-comprar-icone"> Comprar
        </button>
